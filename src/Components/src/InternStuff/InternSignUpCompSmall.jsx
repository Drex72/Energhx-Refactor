...
function InternSignUpCompSmall({
  interests,
  selectedCountry,
  setSelectedCountry,
  province,
        ...
        <fieldset className="my-[2em]">
          ...
          <section className="my-[1.4em]">
            ...
            <input
              ...
              required
              onChange={(event) =>
                setInternData({ ...internData, firstname: event.target.value })
              }
              id="firstname"
            ...
            <input
              ...
              onChange={(event) =>
                setInternData({ ...internData, othername: event.target.value })
              }
              className="form-small-input"
            />
        ...
        <fieldset className="my-[2em]">
          ...
          <section className="my-[1.4em]">
            ...
            <input
              ...
              onChange={(event) =>
                setInternData({ ...internData, postalCode: event.target.value })
              }
              className="form-small-input"
            />
            <section className="my-[1.4em]">
...
export default InternSignUpCompSmall;
