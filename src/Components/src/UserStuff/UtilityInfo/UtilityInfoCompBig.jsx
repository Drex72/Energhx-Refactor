...
import "./utility.css";
function UtilityInfoCompBig({ utilityObject, moveForward, moveBackward }) {
  ...
  const handlePageMove = (e) => {
    ...
    if (allChecked.checkbox2 && allChecked.checkbox2) {
      if (
  ...
  return (
    <main className=" text-white p-[3em]">
      <form className="py-[3em] ">
        <div>
        ...
        {message && (
          <h2
            ref={msgRef}
            className="mb-[2em]  text-red-500 capitalize w-full text-center"
          >
            {message}
          </h2>
        )}
        <fieldset className="flex flex-col gap-[1em] my-6">
          ...
          <div style={style}>
            ...
            <div
              ...
              style={{ color: "white" }}
              className="form-small-input bg-[#3A3A3A] text-[white]  border-2 border-[#2dad00]"
            />
          </div>
          <div>
...
export default UtilityInfoCompBig;
