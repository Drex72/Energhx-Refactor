...
function AdminLogInCompLarge({ AdminData, setAdminData, sendData, formError }) {
  ...
  return (
    <main className="text-white py-[4em]">
      <form className=" container p-[3em] user-form-big">
        ...
        {formError.length > 2 && <div className="mt-2 text-red-500">*{formError}</div>}
...
export default AdminLogInCompLarge;
